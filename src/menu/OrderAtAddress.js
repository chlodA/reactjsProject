...
function OrderAtAddress() {
    ...
    const updateStatus = async (id) => {
        try {
            firebase.firestore().collection('orders').doc(id).update({status: 'completed'}).then((res) => {
                console.log('Item moved to order received');
    ...
    const updateStatusBackward = async (id) => {
        try {
            firebase.firestore().collection('orders').doc(id).update({status: 'ordered'}).then((res) => {
